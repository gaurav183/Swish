...
{  
    ...
    try
    {
        ...
        // file.
        load_image_dataset(images_train, face_boxes_train, faces_directory+"/ballz.xml");
        cout << "reading images_test" << endl;
        load_image_dataset(images_test, face_boxes_test, faces_directory+"/test/ball/ballz.xml");
        cout << "done reading images_test" << endl;
